...
The project would strive to design an API simple to use. Inspired by libs such as [Requests](http://docs.python-requests.org/en/master/).
...
- `text` : The translation for the original text.
